import { BodyPartId, FighterType, TechniqueCategory, Stance, DamageType, Range, ForceVector, VelocityVector, TrajectoryPoint2D, JointAngle, StatScaling } from './types';
