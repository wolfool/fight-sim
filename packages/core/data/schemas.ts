...
export const NaturalWeaponSchema = z.object({
  type: z.enum(['bite', 'claw', 'horn', 'tusk', 'body_slam', 'kick', 'stomp']),
  name: z.string(),
  ...
  usableStates: z.array(z.enum(['STANDING', 'CLINCH', 'GROUND_TOP', 'GROUND_BOTTOM'])),
});

export const NaturalArmorSchema = z.object({
  type: z.enum(['thick_skin', 'fat_layer', 'bone_plate', 'fur', 'scales']),
...
export const ReferenceSchema = z.object({
  type: z.enum(['paper', 'database', 'observation', 'expert']),
  title: z.string(),
...
export const AnimalTraitsSchema = z.object({
  ...
  huntingStyle: z.enum(['ambush', 'chase', 'grapple', 'bite', 'strike', 'pack']),
  preferredRange: z.enum(['close', 'mid', 'long']),
  killMethod: z.enum(['suffocation', 'exsanguination', 'crushing', 'neck_break', 'overwhelm']),
...
export const DetailedAnimalProfileSchema = z.object({
  ...
  ecology: z.object({
    ...
    socialStructure: z.enum(['solitary', 'pair', 'family', 'pack', 'troop', 'herd']),
